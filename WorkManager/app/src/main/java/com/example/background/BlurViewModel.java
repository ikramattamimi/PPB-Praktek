...
public class BlurViewModel extends ViewModel {
    ...
    private Uri getImageUri(Context context) {
        ...
        Uri imageUri = new Uri.Builder()
                ...
                .authority(resources.getResourcePackageName(R.drawable.gundam))
                .appendPath(resources.getResourceTypeName(R.drawable.gundam))
                .appendPath(resources.getResourceEntryName(R.drawable.gundam))
                .build();
